...
public class Timerfor2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        TimeLeft = Mathf.Max(30f, TimeLeft);  // Avoid any negative values for TimeLeft
    ...
    void Update()
    {
        ...
        if (TimerOn)  // Only update the timer if it's active
        {
            ...
            else
            {
                ...
                SceneManager.LoadScene(11);  // Change to the scene name or correct index number
            }
        }
    }
